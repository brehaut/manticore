    ...
    (function (workers) {
        ...
        (function (processing) {
            onmessage = function (message) {
                var _a = message.data, party = _a[0], monsters = _a[1];
                postMessage(manticore.bestiary.allocationsForParty(party, monsters));
                close();
            };
        })(processing = workers.processing || (workers.processing = {}));
